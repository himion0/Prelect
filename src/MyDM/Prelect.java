...
//                locations.put(v.location, arr);
        ...
        System.out.println("Conservaties: "+round(conservatives*100/ voters.size(),4));
        System.out.println("Labour: "+round(labour*100 / voters.size(),4));
        System.out.println("Green: "+round(green*100 / voters.size(),4));
        System.out.println("LibDem: "+round(libdem*100 / voters.size(),4));
        System.out.println("UKIP: "+round(ukip*100 / voters.size(),4));
        System.out.println();
